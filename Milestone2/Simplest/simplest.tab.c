...
#ifndef YY_YY_SIMPLEST_TAB_H_INCLUDED
# define YY_YY_SIMPLEST_TAB_H_INCLUDED
/* Debug traces.  */
#ifndef YYDEBUG
# define YYDEBUG 0
#endif
...
#endif /* !YY_YY_SIMPLEST_TAB_H_INCLUDED  */
...
{
  "$end", "error", "$undefined", "NUM", "'+'", "'-'", "$accept", "line",
  "exp", YY_NULLPTR
};
#endif
