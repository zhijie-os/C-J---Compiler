...
#ifndef YY_YY_PARSER_BISON_H_INCLUDED
...
{
  "$end", "error", "$undefined", "NUMBER", "STRING_Y", "TRUE", "FALSE",
...
#line 114 "parser.y"
                                                                            {yyvsp[-2]->AttachChildren(yyvsp[0]);yyval=yyvsp[-2];}
#line 1699 "parser.bison.cpp"
    break;

  case 49:
#line 117 "parser.y"
                                                                            {yyval=new AST(NodeType::FUNC_CALL, "FUNC_CALL",yyvsp[-3], yyvsp[-1]);;}
#line 1705 "parser.bison.cpp"
    break;

  case 50:
#line 118 "parser.y"
                                                                            {yyval=new AST(NodeType::FUNC_CALL, "FUNC_CALL",yyvsp[-2], new AST(NodeType::ACTUALS,"ACTUALS"));}
#line 1711 "parser.bison.cpp"
    break;

  case 51:
#line 121 "parser.y"
                                                                            {yyval=yyvsp[0];}
#line 1717 "parser.bison.cpp"
    break;

  case 52:
#line 122 "parser.y"
                                                                            {yyval=yyvsp[0];}
#line 1723 "parser.bison.cpp"
    break;

  case 53:
#line 125 "parser.y"
                                                                            {yyvsp[-1]->type=NodeType::UN_ARITHMETIC;yyvsp[-1]->AttachChildren(yyvsp[0]);yyval=yyvsp[-1];}
#line 1729 "parser.bison.cpp"
    break;

  case 54:
#line 126 "parser.y"
                                                                            {yyvsp[-1]->AttachChildren(yyvsp[0]);yyval=yyvsp[-1];}
#line 1735 "parser.bison.cpp"
    break;

  case 55:
#line 127 "parser.y"
                                                                            {yyval=yyvsp[0];}
#line 1741 "parser.bison.cpp"
    break;

  case 56:
#line 130 "parser.y"
                                                                            {yyval=yyvsp[0];}
#line 1747 "parser.bison.cpp"
    break;

  case 57:
#line 131 "parser.y"
                                                                            {yyvsp[-1]->AttachChildren(yyvsp[-2],yyvsp[0]);yyval=yyvsp[-1];}
#line 1753 "parser.bison.cpp"
    break;

  case 58:
#line 132 "parser.y"
                                                                            {yyvsp[-1]->AttachChildren(yyvsp[-2],yyvsp[0]);yyval=yyvsp[-1];}
#line 1759 "parser.bison.cpp"
    break;

  case 59:
#line 133 "parser.y"
                                                                            {yyvsp[-1]->AttachChildren(yyvsp[-2],yyvsp[0]);yyval=yyvsp[-1];}
#line 1765 "parser.bison.cpp"
    break;

  case 60:
#line 136 "parser.y"
                                                                            {yyval=yyvsp[0];}
#line 1771 "parser.bison.cpp"
    break;

  case 61:
#line 137 "parser.y"
                                                                            {yyvsp[-1]->AttachChildren(yyvsp[-2],yyvsp[0]);yyval=yyvsp[-1];}
#line 1777 "parser.bison.cpp"
    break;

  case 62:
#line 138 "parser.y"
                                                                            {yyvsp[-1]->AttachChildren(yyvsp[-2],yyvsp[0]);yyval=yyvsp[-1];}
#line 1783 "parser.bison.cpp"
    break;

  case 63:
#line 141 "parser.y"
                                                                            {yyval=yyvsp[0];}
#line 1789 "parser.bison.cpp"
    break;

  case 64:
#line 142 "parser.y"
                                                                            {yyvsp[-1]->AttachChildren(yyvsp[-2],yyvsp[0]);yyval=yyvsp[-1];}
#line 1795 "parser.bison.cpp"
    break;

  case 65:
#line 143 "parser.y"
                                                                            {yyvsp[-1]->AttachChildren(yyvsp[-2],yyvsp[0]);yyval=yyvsp[-1];}
#line 1801 "parser.bison.cpp"
    break;

  case 66:
#line 144 "parser.y"
                                                                            {yyvsp[-1]->AttachChildren(yyvsp[-2],yyvsp[0]);yyval=yyvsp[-1];}
#line 1807 "parser.bison.cpp"
    break;

  case 67:
#line 145 "parser.y"
                                                                            {yyvsp[-1]->AttachChildren(yyvsp[-2],yyvsp[0]);yyval=yyvsp[-1];}
#line 1813 "parser.bison.cpp"
    break;

  case 68:
#line 148 "parser.y"
                                                                            {yyval=yyvsp[0];}
#line 1819 "parser.bison.cpp"
    break;

  case 69:
#line 149 "parser.y"
                                                                            {yyvsp[-1]->AttachChildren(yyvsp[-2],yyvsp[0]);yyval=yyvsp[-1];}
#line 1825 "parser.bison.cpp"
    break;

  case 70:
#line 150 "parser.y"
                                                                            {yyvsp[-1]->AttachChildren(yyvsp[-2],yyvsp[0]);yyval=yyvsp[-1];}
#line 1831 "parser.bison.cpp"
    break;

  case 71:
#line 153 "parser.y"
                                                                            {yyval=yyvsp[0];}
#line 1837 "parser.bison.cpp"
    break;

  case 72:
#line 154 "parser.y"
                                                                            {yyvsp[-1]->AttachChildren(yyvsp[-2],yyvsp[0]);yyval=yyvsp[-1];}
#line 1843 "parser.bison.cpp"
    break;

  case 73:
#line 157 "parser.y"
                                                                                {yyval=yyvsp[0];}
#line 1849 "parser.bison.cpp"
    break;

  case 74:
#line 158 "parser.y"
                                                                                {yyvsp[-1]->AttachChildren(yyvsp[-2],yyvsp[0]);yyval=yyvsp[-1];}
#line 1855 "parser.bison.cpp"
    break;

  case 75:
#line 163 "parser.y"
                                                            {yyval=yyvsp[0];}
#line 1861 "parser.bison.cpp"
    break;

  case 76:
#line 164 "parser.y"
                                                            {yyval=yyvsp[0];}
#line 1867 "parser.bison.cpp"
    break;

  case 77:
#line 167 "parser.y"
                                                                {yyvsp[-1]->AttachChildren(yyvsp[-2],yyvsp[0]);yyval=yyvsp[-1];}
#line 1873 "parser.bison.cpp"
    break;

  case 78:
#line 170 "parser.y"
                                                            {yyval=yyvsp[0];}
#line 1879 "parser.bison.cpp"
    break;


#line 1883 "parser.bison.cpp"
